...
import widgets
import widgets as wi                                                            # imports pre-defined widgets class
...
VERSION = "170709"                                                              # version of this file (jjmmdd)
...
class FeedAndSpeed():  # =======================================================
    ...
    def __init__(self, rootwin, toolvar, diametervar, speedvar, feedtdvar, feedsovar):
        ...
        self.index_t = 0
        self.index_d = 0
        self.fz = tk.DoubleVar(0,0.05)
        self.vc = tk.DoubleVar(0,100)
        self.z = tk.IntVar(0,2)
        self.ss = tk.DoubleVar(0,10000)
        self.td = tk.DoubleVar(0,diametervar.get())
        self.frtd = tk.DoubleVar(0,self.feedtdvar.get())
        self.frso = tk.DoubleVar(0,0)
...
class ToolTable():  # ==========================================================
    ...
    def load(self):
        ...
        if not tooltable.LcncLoadToolTable(fn):
            tkMessageBox.showerror("Error", "Error loading LinucCNC tool table")
        else:
            self.wints.destroy()
            self.show()
...
class Baseclass(widgets.Widgets):  # ===========================================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        ...
        self.tn = tk.IntVar(0, 6)
        self.td = tk.DoubleVar(0, 6.0)
        self.so = tk.DoubleVar(0, 50.0)
        self.frtd = tk.DoubleVar(0, 1000.0)
        self.frso = tk.DoubleVar(0, 1500.0)
        self.frz = tk.DoubleVar(0, 750.0)
        self.ss = tk.DoubleVar(0, 15000)
        self.zsh = tk.DoubleVar(0, 10.0)
        self.z0 = tk.DoubleVar(0, 0.0)
        self.z1 = tk.DoubleVar(0, -5.0)
        self.zi = tk.DoubleVar(0, 2.5)
        self.posx = tk.DoubleVar(0, 0.0)
        self.posy = tk.DoubleVar(0, 0.0)
        self.rx = tk.DoubleVar(0, 0.0)
        self.ry = tk.DoubleVar(0, 0.0)
        self.deg = tk.DoubleVar(0, 0.0)
        self.plane = tk.IntVar(0, 0)
        self.preamble_gcode = tk.StringVar("", "")
        self.postamble_gcode = tk.StringVar("", "")
        self.preamble_tool = tk.BooleanVar(0, False)
        self.preamble_zsh = tk.BooleanVar(0, False)
        self.preamble_plane = tk.BooleanVar(0, False)
        self.preamble_spindle_cw = tk.BooleanVar(0, False)
        self.preamble_spindle_ccw = tk.BooleanVar(0, False)
        self.preamble_mist = tk.BooleanVar(0, False)
        self.preamble_flood = tk.BooleanVar(0, False)
        self.postamble_zsh = tk.BooleanVar(0, False)
        self.postamble_spindle_off = tk.BooleanVar(0, False)
        self.postamble_coolant_off = tk.BooleanVar(0, False)
...
class CustomGcode(widgets.Widgets):  # =========================================
    ...
    def PasteFromClipboard(self):
        ...
        if tkMessageBox.askokcancel("Paste from clipboard", "Replaces current content.\nSure?"):
            self.textwidget.delete(1.0, tk.END)
    ...
    def Delete(self):
        if tkMessageBox.askokcancel("Delete", "Sure?"):
            self.textwidget.delete(1.0, tk.END)
        self.win.lift()
...
class OutlineRectangle(Baseclass, widgets.Widgets):  # =========================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(OutlineRectangle, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)

        self.w = tk.DoubleVar(0, 50)
        self.h = tk.DoubleVar(0, 25)
        self.contour = tk.IntVar(0, 0) 
        self.climb = tk.BooleanVar(0, True)
        self.br = tk.BooleanVar(0, True)
        self.brw = tk.DoubleVar(0, 2)
        self.brh = tk.DoubleVar(0, 1)
        self.rsx = tk.DoubleVar(0, 0)
        self.rsy = tk.DoubleVar(0, 0)
        self.rsdeg = tk.DoubleVar(0, 0)
...
class OutlineCircle(Baseclass, widgets.Widgets):  # ============================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(OutlineCircle, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)
        
        self.r = tk.DoubleVar(0, 10)
        self.contour = tk.IntVar(0, 0) 
        self.climb = tk.BooleanVar(0, True)
        self.br = tk.BooleanVar(0, True) 
        self.brw = tk.DoubleVar(0, 2) 
...
class OutlineEllipse(Baseclass, widgets.Widgets):  # ===========================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(OutlineEllipse, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)
...
class OutlinePolygon(Baseclass, widgets.Widgets):  # ===========================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(OutlinePolygon, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)
...
class PocketRectangle(Baseclass, widgets.Widgets):  # ==========================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(PocketRectangle, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)
...
class DrillMatrix(Baseclass, widgets.Widgets):  # ==============================
    ...
    def UpdateCanvas(self):
        ...
        self.canvas.delete("all")
        self.canvas.create_line((-10, 0, 10, 0), fill="red")  # Paint cross at origin
...
class OutlineCircularArc(Baseclass, widgets.Widgets):  # =======================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        """Init variables and create widgets"""
        self.win = super(OutlineCircularArc, self).__init__(root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY)
...
class Text(Baseclass, widgets.Widgets):  # =====================================
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        ...
        self.arcjust = tk.IntVar(0, 0)
        self.g64 = tk.DoubleVar(0, 0)
...
class Relief(Baseclass, widgets.Widgets):  # ===================================  UNDER DEVELOPMENT!!!
    ...
    def __init__(self, root, ncclass_instance, winoffsetx=WINPOSX, winoffsety=WINPOSY):
        ...
        self.image_width = tk.IntVar(0, 0)
        self.image_height = tk.IntVar(0, 0)
        self.scale = tk.DoubleVar(0, 0)
        self.image = None
